    ...
    <table width="100%" style="font-family:Saira">    
        <tr>
            <td width="50%">
                    <div style="background-color:#8f5ff5; text-align:center; color:white; box-shadow: 0px 0px 3px 0px #333; cursor:pointer" onclick="location.href='admin/allocate_seat_boys.php';" >
                        <h2 style="font-weight:bold">Click to Allocate Seats to Boys</h2>
                    </div>
                    <div style="height:380px; overflow-y:scroll">
                        <?php 
                            include 'database/connect.php';
                            $query = mysqli_query($connection,"select * from determining_factors where `gender` = 'male' order by `formid` asc"); 
                        ?>
            ...
            <td>
                    ...
                    <div style="background-color:#4cb050; text-align:center; color:white; box-shadow: 0px 0px 3px 0px #333; cursor:pointer" onclick="location.href='admin/allocate_seat_girls.php';">
                        <h2 style="font-weight:bold">Click to Allocate Seats to Girls</h2>
                    </div>
                    <div style="height:380px; overflow-y:scroll">
                        <?php 
                            include 'database/connect.php';
                            $query = mysqli_query($connection,"select * from determining_factors where `gender` = 'female' order by `formid` asc"); 
                        ?>
